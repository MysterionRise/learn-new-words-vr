...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_learning_words p_learning_words;
        ...
        public static SteamVR_Input_ActionSet_learning_words learning_words
        {
            get
            {
                return SteamVR_Actions.p_learning_words.GetCopy<SteamVR_Input_ActionSet_learning_words>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_learning_words = ((SteamVR_Input_ActionSet_learning_words)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_learning_words>("/actions/learning_words")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.learning_words};
        }
    }
}
